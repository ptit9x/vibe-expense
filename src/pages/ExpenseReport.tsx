  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="bg-gradient-to-b from-blue-500 to-blue-600 px-5 pt-4 pb-6">
        <h1 className="text-xl font-semibold text-white mb-1">Báo cáo chi</h1>
        <p className="text-white/60 text-sm">Theo dõi chi tiêu</p>
      </div>
      ...
      <div className="bg-white px-5 py-4">
        <div className="grid grid-cols-2 gap-4">
          <StatCard 
            label={`Tổng chi năm ${selectedYear}`} 
            value={totalExpense} 
            color="#3B82F6" 
          />
          <StatCard 
      ...
      {byCategory.length > 0 && (
        <div className="bg-white mt-2 px-5 py-4">
          <p className="text-sm font-medium text-gray-900 mb-3">Chi tiêu theo danh mục</p>
      ...
      {/* Monthly breakdown */}
      <div className="bg-white mt-2 px-5 py-4">
        <p className="text-sm font-medium text-gray-900 mb-3">Chi tiêu từng tháng</p>
