...
import { Bell, Check, Trash2, ChevronRight, AlertTriangle, Info, CheckCircle, TrendingUp, Loader2 } from 'lucide-react'
...
const NOTIFICATION_COLORS = {
  ...
  inactivity_reminder: 'text-amber-500 bg-amber-50',
  financial_health: 'text-indigo-500 bg-indigo-50',
}

export default function NotificationsPage() {
  const { data: notifications, isLoading, error, refetch } = useAppNotifications()
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">
                      {formatRelativeTime(notif.created_at, t, language)}
                    </p>
                  </div>
...
function formatRelativeTime(dateString: string, t: { common: { justNow: string; minutesAgo: string; hoursAgo: string; daysAgo: string } }, locale: string): string {
